...
export default Model.extend({
  ...
  rdfaBindings: Object.freeze({
    class: "mandaat:Verkiezingsresultaat",
    aantalNaamstemmen: "mandaat:aantalNaamstemmen",
    plaatsRangorde: "mandaat:plaatsRangorde",
    isResultaatVan: "mandaat:isResultaatVan",
    isResultaatVoor: "mandaat:isResultaatVoor",
    gevolg: "mandaat:gevolg"
  })
});
