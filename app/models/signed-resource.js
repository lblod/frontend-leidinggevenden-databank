...
export default Model.extend({
  ...
  versionedBehandeling: belongsTo('versioned-behandeling', { inverse: null }),
  gebruiker: belongsTo('gebruiker', { inverse: null }),

  rdfaBindings: Object.freeze({
    class: "sign:SignedResource",
    content: "sign:text",
    hashValue: "sign:hashValue",
    createdOn: "dct:created",
    status: "sign:status",
    versionedAgenda: "ext:signsAgenda",
    versionedBesluitenLijst: "ext:signsBesluitenlijst",
    versionedNotulen: "ext:signsNotulen",
    versionedBehandeling: "ext:signsBehandeling",
